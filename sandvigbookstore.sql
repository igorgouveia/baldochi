...
--
-- Host: localhost:3306
-- Tempo de geração: 27/11/2019 às 00:42
...
--
-- Fazendo dump de dados para tabela `bookorderitems`
--

INSERT INTO `bookorderitems` (`orderID`, `ISBN`, `qty`, `price`) VALUES
(1, '0131428985', 1, 44.95),
(3, '0321350316', 1, 50.00),
(4, '0321350316', 2, 100.00),
(5, '0596005431', 1, 44.95);
...
--
-- Fazendo dump de dados para tabela `bookorders`
--
...
CREATE TABLE `customer` (
  ...
  `zip` varchar(9) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `customer` (`custID`, `fname`, `lname`, `email`, `street`, `city`, `state`, `zip`) VALUES
(1, 'Igor', 'Gregorio', 'igorgregorio131197@gmail.com', 'Rua Dr. Silvestre Ferraz', 'Itajubá', 'MG', '37500054'),
(2, 'João', 'Fernandes', 'joaofernandes@gmail.com', 'Av. BPS', 'Itajubá', 'MG', '37500050'),
(4, 'Maria', 'Rosário', 'mariarosario@gmail.com', 'Rua Tigre Maia', 'Itajubá', 'MG', '37500052'),
(6, 'Marcos', 'Pereira', 'marcospereira@gmail.com', 'Rua Tigre Maia', 'Itajubá', 'MG', '37500024'),
(7, 'Luciano', 'Araújo', 'lucianoaraujo@gmail.com', 'Rua Tigre Maia', 'Itajubá', 'MG', '37500024');
...
--
ALTER TABLE `bookcategories`
  MODIFY `CategoryID` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
